...
export default function RecentTasksCard({ todos }: RecentTasksCardProps) {
  return (
    <section className="flex min-w-0 flex-1 flex-col gap-2.5">
      ...
      <div className="h-[186px] lg:h-64 rounded-[28px] lg:rounded-[40px] bg-orange-500 dark:bg-[#572810] flex flex-col p-4 lg:px-8 lg:py-[30px] shadow-[0_10px_40px_rgba(255,158,89,0.4)] dark:shadow-none dark:border dark:border-[#a44d1d]">
        {todos.length === 0 ? (
