...
export default function GoalProgress({ progress }: GoalProgressProps) {
  return (
    <div className="flex gap-6 h-[160px] flex-1 shrink-0 items-center rounded-[24px] bg-orange-500 p-8 text-white shadow-[0_10px_20px_rgba(255,158,89,0.4)] lg:w-[308px] lg:flex-none lg:rounded-[32px]">
