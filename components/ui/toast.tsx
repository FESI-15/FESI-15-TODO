...
const toastVariants = cva(
  [
    ...
    "data-starting-style:opacity-0 data-starting-style:translate-x-8",
...
function ToastViewport({ className, ...props }: ToastPrimitive.Viewport.Props) {
  return (
    <ToastPrimitive.Viewport
      ...
      className={cn(
        "pointer-events-none fixed md:right-8 md:bottom-8 right-4 bottom-4 z-50 flex w-[300px] md:w-[500px] flex-col gap-3 outline-none",
        className,
      )}
      {...props}
    />
...
function ToastClose({
  ...
  return (
    <ToastPrimitive.Close
      ...
      render={render}
      className={cn(
        "relative shrink-0 text-white after:absolute after:-inset-2 hover:bg-transparent",
        className,
      )}
      {...props}
    >
