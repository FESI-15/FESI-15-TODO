...
export default function NoteSection({ noteId, noteTitle }: NoteSectionProps) {
  ...
  return (
    <div className="mt-6">
      <p className="text-sm font-semibold text-gray-700 dark:text-white md:text-base mb-2">
        작성된 노트
      </p>
      <Link
        className="p-4 flex items-center gap-2 border border-gray-200 dark:border-border rounded-md"
        href={`/notes/${noteId}`}
      >
