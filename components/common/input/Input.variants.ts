...
//   "w-full p-4 text-base md:p-3 md:text-sm  rounded-2xl border bg-white text-gray-700 placeholder:text-gray-500 transition-colors border-gray-300 focus-visible:border-orange-500 focus-visible:ring-0 aria-invalid:border-red-500 aria-invalid:ring-0",
//   {
//     variants: {
//       size: {
